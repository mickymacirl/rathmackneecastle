...
5.  The user should be redirected to the confirm.html page with the success message being displayed.
...
* Used *[W3C School CSS Image Gallery](https://www.w3schools.com/Css/css_image_gallery.asp)* to add CSS image gallery.
## CSS Sticky Footer
